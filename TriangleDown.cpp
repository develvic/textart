...
protected:
	virtual void getWarpParams(WarpFrameT& warpFrame, SkMatrix& warpMatrix) const
	{
		...
		bpoints.push_back(SkPoint::Make(SkIntToScalar(400), SkIntToScalar(90)));
		...
		tpoints.push_back(SkPoint::Make(SkIntToScalar(400), SkIntToScalar(-10)));
		tpoints.push_back(SkPoint::Make(SkIntToScalar(800), SkIntToScalar(-30)));
